      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto" id="mainNav">
          ...
          <li class="nav-item user-links" style="display: none;">
            <a class="nav-link" href="#"><i class="bi bi-person-circle me-1"></i> Welcome, <span id="userName">abc</span></a>
          </li>
          <li class="nav-item user-links" style="display: none;">
            <a class="nav-link text-warning" href="#" onclick="logout()"><i class="bi bi-box-arrow-right me-1"></i> LOG OUT</a>
          </li>
        </ul>
      </div>
    </div>
