    ...
    <div class="container my-5 py-5">
        ...
        <div class="row align-items-center mt-5">
            <div class="col-lg-6 mb-4">
                <img src="https://images.pexels.com/photos/164595/pexels-photo-164595.jpeg?auto=compress&cs=tinysrgb&w=1200"
                    class="about-image img-fluid" alt="Hotel Story">
            </div>
            <div class="col-lg-6">
                <h3 class="mb-4">A Legacy of Excellence</h3>
                <p class="text-muted">Founded in 2010, The Imperial Crown Hotel has been a beacon of luxury and comfort
                    in the heart of the city. What started as a small boutique hotel has grown into one of the most
                    prestigious addresses in town, known for its exceptional service and attention to detail.</p>
                <p class="text-muted">Over the years, we have welcomed guests from all over the world, providing them
                    with unforgettable experiences and memories that last a lifetime. Our commitment to excellence and
                    continuous improvement has earned us numerous awards and recognition in the hospitality industry.
                </p>
                <p class="text-muted">Today, we continue to uphold our founding principles of quality, integrity, and
                    hospitality, ensuring that every guest feels like royalty from the moment they step through our
                    doors.</p>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="text-muted">To provide exceptional hospitality experiences that exceed our guests'
                                expectations, creating lasting memories through personalized service, luxurious
                                amenities, and attention to every detail.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="text-muted">To be the premier luxury hotel destination, recognized globally for
                                our unwavering commitment to excellence, innovation in hospitality, and creating a home
                                away from home for every guest.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-light py-5">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-4">
                    <div class="card team-card shadow">
                        <img src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=600"
                            class="team-img" alt="John Doe">
                        <div class="card-body text-center">
                            <h4 class="mb-2">Gohel Dhruv </h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card team-card shadow">
                        <img src="https://images.pexels.com/photos/3760263/pexels-photo-3760263.jpeg?auto=compress&cs=tinysrgb&w=600"
                            class="team-img" alt="Jane Smith">
                        <div class="card-body text-center">
                            <h4 class="mb-2">Bhadarka Parth </h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card team-card shadow">
                        <img src="https://images.pexels.com/photos/3778680/pexels-photo-3778680.jpeg?auto=compress&cs=tinysrgb&w=600"
                            class="team-img" alt="Mike Johnson">
                        <div class="card-body text-center">
                            <h4 class="mb-2">Zala Krishnarajsinh</h4>
